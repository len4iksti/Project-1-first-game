...
# 4. Вывод приветствия
# 5. Запрос и вовод имени
# 6. Вывод задания
# 7. Вывод рандомного числа
# 8. Ввод ответа пользователем
# 9. Проверка ответа, сравнение и вывод сообщения

# Вопросы:
# как и куда именно вставить while?
# Завершение опроса и возврат в начало как реализовать?
